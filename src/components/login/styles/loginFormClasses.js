...
export const INPUT_BASE_CLASS = "w-full h-[60px] rounded-[8px] border border-[#D9D9D9] bg-white text-[#050505] font-['Inter',sans-serif] text-[24px] font-normal leading-[32px] focus:border-[#0D54FF] focus:ring-1 focus:ring-[#0D54FF] focus:outline-none";
export const INPUT_EMAIL_CLASS = `${INPUT_BASE_CLASS} px-[20px] placeholder:text-[#828282]`;
export const INPUT_PASSWORD_CLASS = `${INPUT_BASE_CLASS} px-[20px] pr-[60px] placeholder:text-[#828282]`;
