...
export const SECTION_CONTENT = {
  ...
  problemStatement:
    "The current contract for mobility services at Total Brick has reached the end of its term, prompting the company to evaluate new offerings in the market. This review presents an opportunity to ensure the continuity of high-quality, secure, and cost-effective mobile services that meet the demands of a dynamic and growing organization.\n\nTotal Brick aims to assess the latest mobility solutions available from leading providers to determine the best fit for its operational, technical, and financial objectives. The evaluation will focus on maintaining service reliability and network performance, enhancing data security and compliance, and achieving greater transparency and control over costs. Additionally, the company seeks to address any gaps, limitations, or inefficiencies identified in its existing setup—such as coverage inconsistencies, device management challenges, or lack of integration with enterprise systems—while positioning its mobility infrastructure to support future business growth and innovation.",
  scopeOfWork:
    "The scope of this engagement includes the provision of approximately 1,200 mobile voice and data services, 430 data-only services, and 2 satellite voice services to support Total Brick's nationwide operations. These services will be deployed across a diverse user base that includes corporate employees, field staff, and remote project teams operating in both metropolitan and regional locations.The requirement specifically excludes managed services such as Mobile Device Management (MDM); however, providers are expected to ensure that the proposed solutions integrate seamlessly with Total Brick's existing MDM and security frameworks.\n\n•The selected provider must deliver a comprehensive mobility solution encompassing the following capabilities:\n• Ordering and provisioning: Efficient onboarding, activation, and deactivation of services and devices.\n• Reporting: Detailed visibility into usage, costs, and performance through intuitive dashboards and analytics.\n• Billing: Consolidated, accurate, and transparent billing processes that support departmental cost allocation.\n• Operational support: Responsive customer service and technical support to address service issues promptly.\n• Scalability: Flexibility to expand or modify services in line with business growth or changing operational needs.\n\nThe solution should ensure reliable connectivity, cost control, and user satisfaction, while providing the agility needed to support Total Brick's evolving digital and operational landscape.",
